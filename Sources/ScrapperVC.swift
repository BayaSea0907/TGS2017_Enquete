...
class ScrapperVC: UIViewController {
  ...
  @IBOutlet weak var srNext: UIButton!
  ...
  /* 次へボタン ==================================================================*/
  @IBAction func srNextTapped(_ sender: Any) {
    ...
    appDelegate.myUserInfo.q3_1[4] = m_q3_1
    appDelegate.myUserInfo.q3_2[4] = TextView.text!
    appDelegate.myUserInfo.q3_3[4] = Int(q3_3_bar.value)
  ...
  @IBAction func srBackTapped(_ sender: UIButton) {
...
/* ローカライズ ==================================================================*/
  func srLabel()
  {
    q3_1.text = "1mX-Wx-Hj8.text".localized(lang: currentLanguage)
    
    q3_1_1.text = "kia-PC-9z2.text".localized(lang: currentLanguage)
    q3_1_2.text = "Jg9-Af-wJg.text".localized(lang: currentLanguage)
    q3_1_3.text = "lbv-um-rqq.text".localized(lang: currentLanguage)
    q3_1_4.text = "HAZ-PE-7Z5.text".localized(lang: currentLanguage)
    q3_1_5.text = "KS9-yp-Scz.text".localized(lang: currentLanguage)
    q3_1_6.text = "sT1-qC-uYU.text".localized(lang: currentLanguage)
    q3_1_7.text = "Vke-zA-W24.text".localized(lang: currentLanguage)
    
    q3_2.text = "cOu-na-8sd.text".localized(lang: currentLanguage)
    
    q3_3.text = "sC8-Rg-5CS.text".localized(lang: currentLanguage)
    
  //  minLabel.text = "Vbi-eQ-dkn.text".localized(lang: currentLanguage)
   // maxLabel.text = "rHn-Px-xAZ.text".localized(lang: currentLanguage)
  }
