...
class BBLiveVC: UIViewController {
  ...
  @IBOutlet weak var bbNext: UIButton!
  ...
  /* 次へボタン ==================================================================*/
  @IBAction func bbNextTapped(_ sender: Any) {
    ...
    appDelegate.myUserInfo.q3_1[2] = m_q3_1
    appDelegate.myUserInfo.q3_2[2] = TextView.text!
    appDelegate.myUserInfo.q3_3[2] = Int(q3_3_bar.value)
  ...
  @IBAction func bbBackTapped(_ sender: UIButton) {
...
/* ローカライズ ==================================================================*/
  func bbLabel()
  {
    q3_1.text = "9Jz-V7-TUz.text".localized(lang: currentLanguage)
    
    q3_1_1.text = "dsx-DZ-UDY.text".localized(lang: currentLanguage)
    q3_1_2.text = "qgc-h5-OPB.text".localized(lang: currentLanguage)
    q3_1_3.text = "SME-3f-Our.text".localized(lang: currentLanguage)
    q3_1_4.text = "xhm-tG-Ok5.text".localized(lang: currentLanguage)
    q3_1_5.text = "umk-x7-0P6.text".localized(lang: currentLanguage)
    q3_1_6.text = "YEG-Nu-LfK.text".localized(lang: currentLanguage)
    q3_1_7.text = "c5I-YA-JD5.text".localized(lang: currentLanguage)
    
    q3_2.text = "bNV-VM-SgG.text".localized(lang: currentLanguage)
    
    q3_3.text = "E6j-0F-3sO.text".localized(lang: currentLanguage)
    
  //  minLabel.text = "T8d-ul-XHR.text".localized(lang: currentLanguage)
   // maxLabel.text = "OXi-8k-b3F.text".localized(lang: currentLanguage)
  }
